class VariablesController < ApplicationController
  ...
  private
    ...
    def variable_params
      params.require(:variable).permit(:location_options, :exploited_application_options, :social_engineering_options, :user_permissions_options, :operating_system_options, :incident_cause_options, :external_impact, :incident_category_options)
    end
end
